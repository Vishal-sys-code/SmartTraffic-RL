...
from smart_traffic_env.wrappers import NormalizeObservation, ScaleReward
...
def train_ppo(args):
    ...
    def make_env():
        ...
        env = ScaleReward(env, scale_factor=args.reward_scale)
        return env
    ...
    eval_env = UrbanTrafficEnv()
    eval_env = NormalizeObservation(eval_env)
    eval_env = ScaleReward(eval_env, scale_factor=args.reward_scale)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--reward_scale", type=float, default=1e-3, help="Reward scaling factor.")
